Feature: Extract bank statements into reviewable proposals
  ...
  Scenario: A clean statement becomes a proposal ready for review
  ...
  Scenario: A row already in the ledger is recognised as a duplicate, not re-proposed
  ...
  Scenario: A file with unrecognisable columns fails with a helpful reason
  ...
  Scenario: Free-text notes can't be auto-extracted yet
  ...
  Scenario: An already-proposed item is left untouched when processed again
