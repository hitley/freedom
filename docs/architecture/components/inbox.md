...
| --- | --- |
| `index.ts` | _—_ |
| `types.ts` | Component types for the **ingestion inbox** — the durable queue at the head of the bookkeeper pipeline (Capture → Extract → Propose → Reconcile, see `design-notes/001-ingestion-inbox-bookkeeper.md`). |
