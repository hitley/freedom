# Reading a year of spend from observed transactions
...
## Annualised spend scales the observed window to a full year
...
## Transfers between my own accounts are never spend
...
## Income is never counted as spend
...
## A refund is not mistaken for a duplicate of the matching spend
