# A bottom-up budget from recurring expenses
...
**Validated against:** `src/lib/spending/index.ts`, `src/lib/spending/types.ts`

## Each commitment normalises to a monthly-equivalent cost
...
## Inactive commitments are left out of the budget
...
## A linked actual reconciles its occurrence and reports variance
...
## A passed occurrence with no payment is overdue
